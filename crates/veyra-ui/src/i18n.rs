...
const EN: &[(&str, &str)] = &[
    ...
    ("toast.cancel", "Cancel"),
    ("toast.undo", "Undo"),
    ("toast.moved_to_trash", "{count} item(s) moved to Trash"),
    ("toast.copied_to_clipboard", "{count} item(s) copied to clipboard"),
    ...
    ("sidebar.device.open_tab", "Open in New Tab"),
    ("sidebar.device.mount", "Mount"),
    ("sidebar.device.unmount", "Unmount"),
    ("sidebar.device.eject", "Safe Removal / Eject"),
    ("sidebar.device.analyze", "Analyze Disk…"),
    ("sidebar.device.properties", "Properties"),
    ("sidebar.bookmark.open_tab", "Open in New Tab"),
    ("sidebar.bookmark.rename", "Rename Bookmark…"),
    ("sidebar.bookmark.remove", "Remove from Bookmarks"),
    ...
    // --- Command Palette: categories (Faz 59) ---
    ("palette.cat.file_ops", "File Operations"),
    ("palette.cat.navigation", "Navigation"),
    ("palette.cat.view", "View"),
    ("palette.cat.tools", "Tools"),
    ("palette.cat.sort_filter", "Sort & Filter"),
    // --- Command Palette: command titles (Faz 59) ---
    ("palette.cmd.new_folder", "New Folder"),
    ("palette.cmd.new_document", "New Document"),
    ("palette.cmd.compress_selection", "Compress Selection…"),
    ("palette.cmd.extract_archive", "Extract Archive…"),
    ("palette.cmd.empty_trash", "Empty Trash"),
    ("palette.cmd.copy_path", "Copy Path"),
    ("palette.cmd.copy_location", "Copy Location"),
    ("palette.cmd.undo", "Undo"),
    ("palette.cmd.redo", "Redo"),
    ("palette.cmd.new_tab", "New Tab"),
    ("palette.cmd.close_tab", "Close Tab"),
    ("palette.cmd.open_new_window", "Open in New Window"),
    ("palette.cmd.toggle_split_view", "Toggle Dual Pane / Split View"),
    ("palette.cmd.open_terminal", "Open Terminal Here"),
    ("palette.cmd.go_to_location", "Go to Location"),
    ("palette.cmd.select_all", "Select All"),
    ("palette.cmd.toggle_hidden", "Toggle Hidden Files"),
    ("palette.cmd.toggle_preview", "Toggle File Preview"),
    ("palette.cmd.view_icon", "Icon View"),
    ("palette.cmd.view_compact", "Compact View"),
    ("palette.cmd.view_details", "Details View"),
    ("palette.cmd.analyze_disk", "Analyze Disk Usage…"),
    ("palette.cmd.storage_dashboard", "Smart Storage Dashboard…"),
    ("palette.cmd.connect_server", "Connect to Server…"),
    ("palette.cmd.properties", "Open Properties"),
    ("palette.cmd.search_files", "Search Files"),
    (
        "palette.cmd.manage_file_associations",
        "Manage File Associations…",
    ),
    ("palette.cmd.preferences", "Preferences"),
    ("palette.cmd.keyboard_shortcuts", "Keyboard Shortcuts"),
    ("palette.cmd.reset_shortcuts", "Reset Shortcuts to Default"),
    ("palette.cmd.toggle_developer_mode", "Toggle Developer Mode"),
    ("palette.cmd.copy_absolute_path", "Copy Absolute Path"),
    ("palette.cmd.copy_file_uri", "Copy File URI"),
    (
        "palette.cmd.calculate_checksums",
        "Calculate Checksums (SHA-256 / MD5)",
    ),
    ("palette.cmd.open_in_editor", "Open in Default Code Editor"),
    ("palette.cmd.sort_name", "Sort by Name"),
    ("palette.cmd.sort_size", "Sort by Size"),
    ("palette.cmd.sort_modified", "Sort by Modified"),
    ("palette.cmd.sort_type", "Sort by Type"),
    ...
    // --- Preferences: Privacy ---
    ("prefs.privacy.group.thumbnail_cache", "Thumbnail Cache"),
    ("prefs.privacy.clear_thumbnails.title", "Thumbnail Cache Size"),
    (
        "prefs.privacy.clear_thumbnails.subtitle",
        "{size} of cached thumbnail images on disk",
    ),
...
const TR: &[(&str, &str)] = &[
    ...
    ("headerbar.split.tooltip", "Çift Panel Görünümü (F3)"),
    ...
    ("toast.cancel", "İptal"),
    ("toast.undo", "Geri Al"),
    ("toast.moved_to_trash", "{count} öge çöpe taşındı"),
    ("toast.copied_to_clipboard", "{count} öge panoya kopyalandı"),
    // --- Status bar / item counts (window.rs) ---
    ...
    ("sidebar.device.open_tab", "Yeni Sekmede Aç"),
    ("sidebar.device.mount", "Bağla"),
    ("sidebar.device.unmount", "Ayır"),
    ("sidebar.device.eject", "Güvenle Kaldır / Çıkar"),
    ("sidebar.device.analyze", "Diski Analiz Et…"),
    ("sidebar.device.properties", "Özellikler"),
    ("sidebar.bookmark.open_tab", "Yeni Sekmede Aç"),
    ("sidebar.bookmark.rename", "Yer İmini Yeniden Adlandır…"),
    ("sidebar.bookmark.remove", "Yer İmlerinden Kaldır"),
    ("sidebar.network", "Ağ"),
    ...
    // --- Komut Paleti: kategoriler (Faz 59) ---
    ("palette.cat.file_ops", "Dosya İşlemleri"),
    ("palette.cat.navigation", "Gezinme"),
    ("palette.cat.view", "Görünüm"),
    ("palette.cat.tools", "Araçlar"),
    ("palette.cat.sort_filter", "Sırala ve Filtrele"),
    // --- Komut Paleti: komut başlıkları (Faz 59) ---
    ("palette.cmd.new_folder", "Yeni Klasör"),
    ("palette.cmd.new_document", "Yeni Belge"),
    ("palette.cmd.compress_selection", "Seçimi Sıkıştır…"),
    ("palette.cmd.extract_archive", "Arşivi Ayıkla…"),
    ("palette.cmd.empty_trash", "Çöpü Boşalt"),
    ("palette.cmd.copy_path", "Yolu Kopyala"),
    ("palette.cmd.copy_location", "Konumu Kopyala"),
    ("palette.cmd.undo", "Geri Al"),
    ("palette.cmd.redo", "Yinele"),
    ("palette.cmd.new_tab", "Yeni Sekme"),
    ("palette.cmd.close_tab", "Sekmeyi Kapat"),
    ("palette.cmd.open_new_window", "Yeni Pencerede Aç"),
    (
        "palette.cmd.toggle_split_view",
        "Çift Panel / Bölünmüş Görünümü Aç/Kapat",
    ),
    ("palette.cmd.open_terminal", "Burada Terminal Aç"),
    ("palette.cmd.go_to_location", "Konuma Git"),
    ("palette.cmd.select_all", "Tümünü Seç"),
    ("palette.cmd.toggle_hidden", "Gizli Dosyaları Göster/Gizle"),
    ("palette.cmd.toggle_preview", "Dosya Önizlemeyi Aç/Kapat"),
    ("palette.cmd.view_icon", "Simge Görünümü"),
    ("palette.cmd.view_compact", "Kompakt Görünüm"),
    ("palette.cmd.view_details", "Ayrıntılı Görünüm"),
    ("palette.cmd.analyze_disk", "Disk Kullanımını Analiz Et…"),
    ("palette.cmd.storage_dashboard", "Akıllı Depolama Panosu…"),
    ("palette.cmd.connect_server", "Sunucuya Bağlan…"),
    ("palette.cmd.properties", "Özellikleri Aç"),
    ("palette.cmd.search_files", "Dosya Ara"),
    (
        "palette.cmd.manage_file_associations",
        "Dosya İlişkilendirmelerini Yönet…",
    ),
    ("palette.cmd.preferences", "Tercihler"),
    ("palette.cmd.keyboard_shortcuts", "Klavye Kısayolları"),
    (
        "palette.cmd.reset_shortcuts",
        "Kısayolları Varsayılana Sıfırla",
    ),
    (
        "palette.cmd.toggle_developer_mode",
        "Geliştirici Modunu Aç/Kapat",
    ),
    ("palette.cmd.copy_absolute_path", "Mutlak Yolu Kopyala"),
    ("palette.cmd.copy_file_uri", "Dosya URI'sini Kopyala"),
    (
        "palette.cmd.calculate_checksums",
        "Sağlama Toplamlarını Hesapla (SHA-256 / MD5)",
    ),
    (
        "palette.cmd.open_in_editor",
        "Varsayılan Kod Düzenleyicide Aç",
    ),
    ("palette.cmd.sort_name", "Ada Göre Sırala"),
    ("palette.cmd.sort_size", "Boyuta Göre Sırala"),
    (
        "palette.cmd.sort_modified",
        "Değiştirilme Tarihine Göre Sırala",
    ),
    ("palette.cmd.sort_type", "Türe Göre Sırala"),
    ...
    // --- Preferences: Privacy ---
    ("prefs.privacy.group.thumbnail_cache", "Küçük Resim Önbelleği"),
    ("prefs.privacy.clear_thumbnails.title", "Küçük Resim Önbellek Boyutu"),
    (
        "prefs.privacy.clear_thumbnails.subtitle",
        "Diskte {size} önbelleğe alınmış küçük resim var",
    ),
